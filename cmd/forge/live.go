...
func runLiveRoster(ctx context.Context, store liveStore, executionID string, canceller tui.Canceller, retrier tui.Retrier, resumer tui.Resumer, approver tui.Approver, answerer tui.Answerer) error {
